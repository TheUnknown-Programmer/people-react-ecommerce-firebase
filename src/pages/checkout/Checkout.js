...
const Checkout = () => {
  ...
  const [message, setMessage] = useState('Initializaing checkout...');
  ...
  const description = `ThePeople payment: email: ${customerEmail}, Ammount: ${totalAmount}`
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:4242/create-payment-intent", {
      ...
      .catch((error) => {
        setMessage('Failed to Checkout. Try Again')
